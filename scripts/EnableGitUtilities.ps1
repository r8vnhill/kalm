<#
.SYNOPSIS
    Loads the Knob.Git module from the local git/ps1 path.

.DESCRIPTION
    This script locates and attempts to import the `Knob.Git.psd1` module from a relative
...
.NOTES
    ...
    <script root>/git/ps1/Knob.Git.psd1

.EXAMPLE
    .\Initialize-GitModule.ps1
    Imports the Knob.Git module from the relative path.
#>

[CmdletBinding()]
param ()

$modulePath = Join-Path -Path $PSScriptRoot -ChildPath 'git\ps1\Knob.Git.psd1'
