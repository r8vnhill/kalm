 ...
 * Its purpose is to provide **type-safe, validated primitives** and **contracts** that higher-level Keen modules (e.g.,
 * math, core, examples) can build upon.
 *
 * ## Key points
 * - Applies the shared Keen library convention (`keen.library`).
...
plugins {
    // Applies Keen’s internal convention for library modules (Kotlin/JVM, publishing, etc.)
    id("keen.library")
